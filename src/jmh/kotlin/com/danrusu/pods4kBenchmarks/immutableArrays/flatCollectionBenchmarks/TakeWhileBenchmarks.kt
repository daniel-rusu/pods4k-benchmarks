...
open class TakeWhileBenchmarks : FlatCollectionBenchmark() {
    ...
    fun takeWhile(bh: Blackhole) {
        transformEachCollection(
            ...
            // persistent lists
            { list: PersistentList<String> -> list.takeWhile { FlatDataFilter.shouldAccept(it) } },
            { list: PersistentList<Boolean> -> list.takeWhile { FlatDataFilter.shouldAccept(it) } },
            { list: PersistentList<Byte> -> list.takeWhile { FlatDataFilter.shouldAccept(it) } },
            { list: PersistentList<Char> -> list.takeWhile { FlatDataFilter.shouldAccept(it) } },
            { list: PersistentList<Short> -> list.takeWhile { FlatDataFilter.shouldAccept(it) } },
            { list: PersistentList<Int> -> list.takeWhile { FlatDataFilter.shouldAccept(it) } },
            { list: PersistentList<Float> -> list.takeWhile { FlatDataFilter.shouldAccept(it) } },
            { list: PersistentList<Long> -> list.takeWhile { FlatDataFilter.shouldAccept(it) } },
            { list: PersistentList<Double> -> list.takeWhile { FlatDataFilter.shouldAccept(it) } },
